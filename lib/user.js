...
var User = function () {
  ...
  _createClass(User, [{
    ...
    value: function addTask(description) {
      var task = User.createTask(description);
    ...
    value: function getTask(id) {
      ...
      if (!task) {
        return _boom2.default.boomify(new Error('Task ID not found.'), { statusCode: 404 });
      }
      return task;
    }
        ...
        for (var _iterator = this.tasks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (task.id === id) {
            if (task.state === COMPLETE) {
              return _boom2.default.boomify(new Error('Task is already complete.'), { statusCode: 400 });
            }
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                users = [];
                _context3.next = 8;
                return client.set(key, users, TTL);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                ...
                _context5.next = 10;
                return client.set(keyUsers, users, TTL);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                keyUser = { id: user.id, segment: 'users' };
                _context6.next = 4;
                return client.set(keyUser, user, TTL);
    ...
    key: 'setSessionKey',
    value: function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(client, user) {
        var sid, keySession;
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                sid = (0, _v2.default)();
                keySession = { id: sid, segment: 'session' };
                _context8.next = 4;
                return client.set(keySession, user.id, TTL);

              case 4:
                return _context8.abrupt('return', sid);
      ...
      function setSessionKey(_x13, _x14) {
    ...
    key: 'removeSessionKey',
    value: function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(client, sid) {
        var keySession;
      ...
      function removeSessionKey(_x15, _x16) {
    ...
    key: 'getUserWithSessionID',
    value: function () {
      var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(client, sid) {
        var keySession, value, id;
      ...
      function getUserWithSessionID(_x17, _x18) {
        return _ref10.apply(this, arguments);
      }

      return getUserWithSessionID;
    }()
  }]);
